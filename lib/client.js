var ace, exec, load, io, join, daffy, restafary, loadRemote;
...
(function(global) {
    ...
    function Edward() {
        ...
        function loadFiles(callback) {
            exec.series([
                function(callback) {
                    exec.if(load, callback, function() {
                        loadScript(PREFIX + DIR + 'load/load.js', callback);
                    });
                },
                
                function(callback) {
                    exec.if(join, callback, function() {
                        loadScript(PREFIX + '/join/join.js', callback);
                    });
                },
                
                function(callback) {
                    load.js(PREFIX + '/lib/client/loadremote.js', callback);
                },
