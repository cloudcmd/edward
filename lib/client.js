var ace, exec, load, DOM, io, daffy, restafary;

(function(global, Files, loadRemote) {
    'use strict';
    ...
    function Edward() {
        var Ace,
            ...
            edward      = function(el, options, callback) {
                ...
                loadScript(PREFIX + '/modules/execon/lib/exec.js', init);
            };
