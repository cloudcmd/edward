...
(function(global) {
    ...
    function Edward() {
        ...
        edward.addKeyMap        = function(keyMap) {
            var map = [];
       ...
       function setKeyMap(options) {
            var keyMap = options && options.keyMap;
            
            if (keyMap && keyMap !== 'default')
                Ace.setKeyboardHandler('ace/keyboard/' + keyMap);
        ...
        edward.setModeForPath   = function(path) {
        ...
        edward.selectAll    = function() {
            Ace.selectAll();
            edward.copyToClipboard();
            return edward;
        };
        
        edward.copyToClipboard = function() {
        ...
        edward.cutToClipboard = function() {
        ...
        edward.pasteFromClipboard = function() {
        ...
        function clipboard(cmd) {
            ...
            if (cmd === 'paste') {
                ...
                textarea.value = Ace.getSelectedText();
